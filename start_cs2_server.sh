...
rm -rf /home/${user}/cs2/game/csgo/cfg/MatchZy
...
rm -rf /home/${user}/cs2/game/csgo/addons/counterstrikesharp/plugins/CS2Rcon*
wget -O CS2Rcon-latest.zip $(curl -s https://api.github.com/repos/LordFetznschaedl/CS2Rcon/releases/latest | grep -oP '"browser_download_url": "\K[^"]*CS2Rcon-\d+\.\d+\.\d+\.zip')
unzip CS2Rcon-latest.zip
